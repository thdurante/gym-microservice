...
RSpec.describe TrainingSessionsController, type: :controller do
  ...
  # TrainingSession. As you add validations to TrainingSession, be sure to
  ...
  # TrainingSessionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested training_session' do
        ...
        expect(training_session.name).to eq(new_attributes[:name])
      end
